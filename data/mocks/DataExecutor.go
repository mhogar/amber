...
func (_m *DataExecutor) GetUserRoleForClient(clientUID uuid.UUID, username string) (*models.UserRole, error) {
...
func (_m *DataExecutor) GetUserRolesForClient(clientUID uuid.UUID) ([]*models.UserRole, error) {
