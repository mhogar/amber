...
// IScopeFactory is an autogenerated mock type for the IScopeFactory type
type IScopeFactory struct {
	mock.Mock
}

// CreateDataExecutorScope provides a mock function with given fields: _a0
func (_m *IScopeFactory) CreateDataExecutorScope(_a0 func(data.DataExecutor) error) error {
	ret := _m.Called(_a0)
...
func (_m *IScopeFactory) CreateTransactionScope(_a0 data.DataExecutor, _a1 func(data.Transaction) (bool, error)) error {
