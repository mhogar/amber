...
func (_m *DataCRUD) GetScopeByName(name string) (*models.Scope, error) {
	ret := _m.Called(name)
...
func (_m *DataCRUD) SaveScope(scope *models.Scope) error {
	ret := _m.Called(scope)
...
func (_m *DataCRUD) UpdateClient(client *models.Client) error {
	ret := _m.Called(client)
